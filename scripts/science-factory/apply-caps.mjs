...
const source=resolveRepoPath(process.argv[2]||'.cache/science-factory/reproduce-electric/compacted');
const out=resolveRepoPath(process.argv[3]||'.cache/science-factory/reproduce-electric/capped');
